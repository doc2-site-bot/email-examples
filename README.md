...
The content is provided in Google Docs see Project: <https://drive.google.com/drive/folders/1uaz_fqzAD5K3giQmfumNAyhyloKUdaVm> and styled via the [SSR configuration](./doc2.email.config.json). 
...
Open <http://localhost:3000/github> with your browser to see the result. Modify the [SSR configuration](./doc2.email.config.json) then refresh the page to see the changes applied.
...
The [SSR configuration](./doc2.email.config.json) holds selectors to apply styling and custom properties to these components. 
